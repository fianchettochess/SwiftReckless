...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/jaredbrewer/SwiftReckless/releases/download/0.9.3/RecklessFFI.xcframework.zip",
            checksum: "57057749ac55d0c97ea98bf4ffd7df4bfe7775edbcdaf17ab6cb1c7696e6e4ac"
        ),
        .target(
            name: "CReckless",
