...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/fianchettochess/SwiftReckless/releases/download/0.9.7/RecklessFFI.xcframework.zip",
            checksum: "fefb8de42a505a17c0621ea28d49b76d34dd4b7014c0433f743807ef4ba19c1e"
        ),
        .target(
            name: "CReckless",
