...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/fianchettochess/SwiftReckless/releases/download/0.9.10/RecklessFFI.xcframework.zip",
            checksum: "1fd290d948df6a5559237dd98df3a9c1d359dfd09e176f85e48d01851a10df2b"
        ),
        .target(
            name: "CReckless",
