...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/jaredbrewer/SwiftReckless/releases/download/0.9.2/RecklessFFI.xcframework.zip",
            checksum: "dcc7d232e2ce89776aecb4b4fb41c44c6ba0ddc8932237c719bf08967f5141fd"
        ),
        .target(
            name: "CReckless",
