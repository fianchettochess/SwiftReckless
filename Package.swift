...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/fianchettochess/SwiftReckless/releases/download/0.9.8/RecklessFFI.xcframework.zip",
            checksum: "764a0691f23680fc48a160587aba797d21c8adb5ce6be1f85e6c9fab02465d32"
        ),
        .target(
            name: "CReckless",
