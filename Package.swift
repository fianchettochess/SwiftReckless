...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/fianchettochess/SwiftReckless/releases/download/0.9.15/RecklessFFI.xcframework.zip",
            checksum: "f2fdfeea4fbe4f022a418c02660c21465ab7f5e1b9f1e479f10cb1a05ca9a7df"
        ),
        .target(
            name: "CReckless",
