...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/jaredbrewer/SwiftReckless/releases/download/0.9.4/RecklessFFI.xcframework.zip",
            checksum: "3593c1294a02b5deb4967901588c3b6e29c71051b9debcb696c85666e087114d"
        ),
        .target(
            name: "CReckless",
