...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/fianchettochess/SwiftReckless/releases/download/0.9.9/RecklessFFI.xcframework.zip",
            checksum: "318ff019bc7f756829873693dd90dc2eac3f738a5fa081a17c0ba4f3a9142b0d"
        ),
        .target(
            name: "CReckless",
