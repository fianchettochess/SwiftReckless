...
if useBinaryEngine {
    ...
    engineTargets = [
        .binaryTarget(
            name: "RecklessFFI",
            url: "https://github.com/jaredbrewer/SwiftReckless/releases/download/0.9.0/RecklessFFI.xcframework.zip",
            checksum: "a682da28ba2b60c8a7d92ecf590990bc76765de79cbfc730cf1e66bcb24ba919"
        ),
        .target(
            name: "CReckless",
